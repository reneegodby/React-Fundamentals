...
class BronzeLevelUser extends User {
  ...
  constructor(username, password, ccinfo) {
    //if you're going to use 'this' in your constructor, you must have super that points to the parent constructor. JavaScript requires us to call the super() function inside of our constructor inside of derived classes.
    super(username, password);
    //the 'this' keyword wouldn't work without super
    (this.type = "Bronze User"), (this.ccinfo = ccinfo);
  }
  getInfo() {
